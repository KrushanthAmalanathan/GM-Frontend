      ...
      <div className='flex h-[50px] flex-row justify-between bg-PMnavbar w-[100%] mt-3 pb-3 shadow-md font-BreeSerif my-10'>
        <div className='flex flex-row h-[66px] justify-between mt-1 mb-2 ml-12'>
          ...
          <Link to="/rmRequests/create" >
            <button className='h-10 bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>Add Stocks</button>
          </Link>
          <Link to="/RawmRequests" >
            <button className='h-[40px] bg-PMnavbar hover:bg-gray-500 w-40 text-ternary rounded-xl'>All Stocks</button>
          </Link>
          <Link to="/RawsuRequests" >
            <button className='h-[40px] bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>pre_sale_items</button>
          </Link>
          <Link to="/StoreShoppingPage" >
            <button className='h-[40px] bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>Shop Preview</button>
          </Link>
        </div>
      </div>
    </div>
