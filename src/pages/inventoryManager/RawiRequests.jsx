...
const RawiRequests = () => {
    ...
    const headers = ['Item ID', 'Item Name', 'Condition', 'Item Weight', 'Description', 'Operations'];
    ...
    const filteredRequests = rmrequests.filter((v) => v.ItemType.toLowerCase() === 'inventory');

    return (
        <div className='relative'>
            <PMHeader />
            <div className="text-center font-bold text-3xl mb-4">INVENTORY STOCKS</div>
            <div className='flex justify-between items-center m-5'>
                <div className='flex justify-between items-center m-5 font-BreeSerif'>
                    ...
                    <Link to='/RawioRequests'>
                        <button className='p-2 bg-blue-300 m-8 text-black rounded-xl'>Old Stock</button>
                    </Link>
                </div>
            </div>
