...
const RawinRequests = () => {
    ...
    const filteredRequests = rmrequests.filter((v) => v.Condition.toLowerCase() === 'new');

    return (
        <div className='relative'>
            <PMHeader />
            <div className="text-center font-bold text-3xl mb-4">INVENTORY NEW STOCKS</div>
            ...
            {loading ? (
                ...
                <div>
                    <table className='mx-auto font-BreeSerif'>
                        ...
                        <tbody>
                            {rmrequests
                                .filter((v) => v.Condition.toLowerCase() === 'new')
                                .map((rmrequest, index) => (
